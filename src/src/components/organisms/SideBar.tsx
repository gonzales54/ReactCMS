  ...
  return (
    <div className="sideBar">
      <ul className="sideMenu">
        ...
        <li className="sideMenuItem">
          <Link to='/posts' className={path === '/posts' ? "sideMenuLink activeSideMenuLink" : "sideMenuLink"}>
            <p className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="icons">
        ...
        <li className="sideMenuItem">
          <Link to='/setting' className={path === '/setting' ? "sideMenuLink activeSideMenuLink" : "sideMenuLink"}>
            <p className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="icons">
